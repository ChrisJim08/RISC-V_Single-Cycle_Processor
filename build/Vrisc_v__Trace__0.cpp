...
void Vrisc_v___024root__trace_chg_0_sub_0(Vrisc_v___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY((vlSelfRef.__Vm_traceActivity[1U]))) {
        ...
        bufp->chgIData(oldp+11,(vlSelfRef.risc_v__DOT__pc),32);
        bufp->chgIData(oldp+12,(((IData)(4U) + vlSelfRef.risc_v__DOT__pc)),32);
        bufp->chgIData(oldp+13,((((0x6fU == (0x7fU 
                                             & vlSelfRef.risc_v__DOT__instr)) 
                                  | ((0x67U == (0x7fU 
                                                & vlSelfRef.risc_v__DOT__instr)) 
                                     | (vlSelfRef.risc_v__DOT__alu_result 
        ...
        bufp->chgBit(oldp+14,((1U & vlSelfRef.risc_v__DOT__alu_result)));
        bufp->chgIData(oldp+15,(vlSelfRef.risc_v__DOT__alu_src2),32);
        bufp->chgIData(oldp+16,(vlSelfRef.risc_v__DOT__alu_result),32);
        bufp->chgIData(oldp+17,(((2U & (IData)(vlSelfRef.risc_v__DOT__regf_rd_src))
        ...
        bufp->chgIData(oldp+18,(vlSelfRef.risc_v__DOT__regf_rs1_data),32);
        bufp->chgIData(oldp+19,(vlSelfRef.risc_v__DOT__regf_rs2_data),32);
        bufp->chgIData(oldp+20,(((0x17U == (0x7fU & vlSelfRef.risc_v__DOT__instr))
                                  ? vlSelfRef.risc_v__DOT__target_pc
                                  : vlSelfRef.risc_v__DOT__imm)),32);
        bufp->chgIData(oldp+21,(vlSelfRef.risc_v__DOT__data_mem_r_data),32);
        bufp->chgIData(oldp+22,(vlSelfRef.risc_v__DOT__imm),32);
        bufp->chgIData(oldp+23,(vlSelfRef.risc_v__DOT__instr),32);
        bufp->chgIData(oldp+24,(((0x4000U & vlSelfRef.risc_v__DOT__instr)
        ...
        bufp->chgCData(oldp+25,((0x7fU & vlSelfRef.risc_v__DOT__instr)),7);
        bufp->chgCData(oldp+26,((7U & (vlSelfRef.risc_v__DOT__instr 
                                       >> 0xcU))),3);
        bufp->chgBit(oldp+27,((1U & (vlSelfRef.risc_v__DOT__instr 
                                     >> 0x1eU))));
        bufp->chgCData(oldp+28,((0x1fU & (vlSelfRef.risc_v__DOT__instr 
                                          >> 7U))),5);
        bufp->chgCData(oldp+29,((0x1fU & (vlSelfRef.risc_v__DOT__instr 
                                          >> 0xfU))),5);
        bufp->chgCData(oldp+30,((0x1fU & (vlSelfRef.risc_v__DOT__instr 
                                          >> 0x14U))),5);
        bufp->chgBit(oldp+31,((1U & (vlSelfRef.risc_v__DOT__imem__DOT__mem
                                     [(0x3ffU & (vlSelfRef.risc_v__DOT__pc 
                                                 >> 2U))] 
                                     >> 0x1eU))));
        bufp->chgIData(oldp+32,(vlSelfRef.risc_v__DOT__ctrl_flow_unit__DOT__base_addr),32);
        bufp->chgSData(oldp+33,((0x3ffU & (vlSelfRef.risc_v__DOT__alu_result 
                                           >> 2U))),10);
        bufp->chgSData(oldp+34,((0x3ffU & (vlSelfRef.risc_v__DOT__pc 
                                           >> 2U))),10);
        bufp->chgCData(oldp+35,((3U & vlSelfRef.risc_v__DOT__alu_result)),2);
        bufp->chgCData(oldp+36,(vlSelfRef.risc_v__DOT__ld_data_ext__DOT__byte_sel),8);
        bufp->chgSData(oldp+37,(vlSelfRef.risc_v__DOT__ld_data_ext__DOT__halfword_sel),16);
