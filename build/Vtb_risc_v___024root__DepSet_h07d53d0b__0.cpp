...
VL_INLINE_OPT void Vtb_risc_v___024root___act_sequent__TOP__0(Vtb_risc_v___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vtb_risc_v__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_risc_v___024root___act_sequent__TOP__0\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
...
#endif
            VL_FATAL_MT("sim/tb_risc_v.sv", 3, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("sim/tb_risc_v.sv", 3, "", "Active region did not converge.");
            }
